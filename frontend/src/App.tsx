...
import { Activity, Gauge, ShieldAlert, SlidersHorizontal } from "lucide-react";
    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <p className="subtitle" style={{ marginTop: 32 }}>
          <ShieldAlert size={14} style={{ verticalAlign: "middle" }} /> Synthetic test-mode only. Does not move real money.
        </p>
      </aside>
      <main className="main">
        <Routes>
